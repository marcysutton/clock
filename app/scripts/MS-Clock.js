...
MS.POP_Clock.prototype = {
	...
	moveStack: function(stack, listItems, relevantTime) {
		...
		if(stack.ms_pop_clock_current){
			stack.ms_pop_clock_current.removeClass('current');
		}
		var current = $(listItems[relevantTime]).addClass('current');
		
		stack.ms_pop_clock_current = current;
